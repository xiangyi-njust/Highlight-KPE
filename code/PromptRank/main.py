...
def get_setting_dict():
    setting_dict = {"max_len": 512, "temp_en": "Book:", "temp_de": "This book mainly talks about ", "model": "base",
                    "enable_filter": True, "enable_pos": True, "position_factor": 1.2e8, "length_factor": 0.6}
    # setting_dict["temp_en"] = "Highlights:"
    # setting_dict["temp_de"] = "These highlights mainly talk about "
    return setting_dict
...
def main():
    ...
    # log = Logger(args.log_dir + args.dataset_name + '/a.log')
    log = Logger("useless.log")
    start = time.time()
    ...
    # model = T5ForConditionalGeneration.from_pretrained("weight/t5_base")
    model.to(device)
...
class Logger(object):
    ...
    def __init__(self, filename, level='info'):
        ...
        th = logging.FileHandler(filename, 'w', encoding='utf-8')
